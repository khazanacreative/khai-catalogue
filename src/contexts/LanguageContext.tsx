...
const translations = {
  id: {
    ...
    productsSubtitle: "Katalog produk langsung dari Google Sheets.",
    allCategories: "Semua",
    noProducts: "Belum ada produk yang ditemukan.",
  ...
  en: {
    ...
    productsSubtitle: "Product catalog powered by Google Sheets.",
    allCategories: "All",
